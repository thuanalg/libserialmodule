	...
	LPVOID arg)
{
	...
	DWORD bytesRead = 0;
	DWORD bytesWrite = 0;
	SP_SERIAL_GENERIC_ST *ecb_buf = 0;
	int portlen = 0;
	int evtcode = 0;
	char *tbuffer = 0;
	char evtbytes[SPSR_EVT_CB_CART_LEN] = {0};
	ecb_buf = (SP_SERIAL_GENERIC_ST *)evtbytes;
